...
class Product {
  ...
  addToCard() {
    ...
    thisProduct.prepareCartProduct(thisProduct);
  }
...
class Cart {
  ...
  add(menuProduct) {
    ...
    thisCart.products.push(new CartProduct(menuProduct, cartDom));
...
const app = {
  ...
  initData: function () {
    ...
    console.log('thisApp.data', JSON.stringify(thisApp.date));
